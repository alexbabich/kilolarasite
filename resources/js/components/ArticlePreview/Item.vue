<template>
    ...
    >
        ...
        <div class="df-item-text-wrapper">
            <p class="df-item-title" v-html="this.title" v-if="this.title"></p>
            <div class="df-item-text" v-html="this.description" v-if="this.description"></div>
        </div>
    </div>
</template>
